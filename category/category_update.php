...
$access_page_id = "/category/category_update.php";
...
if ($system_id == "none" ) {
$show_status = "error";
$array_report_error[] = "- กรุณาเลือกระบบ "; 
}

if ($category_id_root_select == "" ) {
$show_status = "error";
$array_report_error[] = "- กรุณาเลือกหมวดหมู่หลัก "; 
}

if ($category_name == "" ) {
$show_status = "error";
$array_report_error[] = "- กรุณากรอกชื่อหมวดหมู่ "; 
}
...
$main_rs = $app_category->function_viewbyset( $input_array ); /// select ข้อมูล
*/
...
$page_topic_name = "เพิ่ม/แก้ไข ข้อมูลหมวดหมู่  "; 
            ...
            <td height="30" bgcolor="#FFFFFF" ><table width="100%" border="0" cellpadding="0" cellspacing="0">
              <tr>
                ...
                <td width="300" align="right"><table border="0" cellpadding="0" cellspacing="5">
                  <tr>
                    <td width="60" align="center" valign="top"><a href="category_showall.php?system_id=<?=$system_id?>"><img src="../images/icon/icon_all.gif" width="164" height="35" hspace="0" /></a></td>
...
<td width="60" align="center" valign="top">
 <a href="category_showall.php?<? print "category_id=$category_id&option_delete=delete&system_id=$system_id" ; ?>"   onclick="return confirm('คุณต้องการลบข้อมูลใช่หรือไม่ ?')"  >
...
?>
   <td width="60" align="center" valign="top"><a href="category_update.php?system_id=<?=$system_id?>"><img src="../images/icon/design_icon_add.gif" alt="เพิ่ม" width="164" height="35" hspace="0" border="0" /></a></td>
                  </tr>
                </table></td>
              </tr>
            </table></td>
      ...
      <table width="100%" border="0" cellpadding="0" cellspacing="1" bgcolor="#999999">
        <tr>
          <td height="50" align="left" valign="top" bgcolor="#FFFFFF"  style="padding:3px; background-color:#FFFFFF"><table width="100%" border="0" cellpadding="0" cellspacing="1" bgcolor="#FFFFFF" class="text_normal1">
            <tr>
              <td width="200" align="right" valign="middle" bgcolor="#FFFFFF"  style="padding:5px; background-color:#E5E5E5"> หมวดหลัก <font color="#FF0000">*</font> :</td>
...
print "<option value=\"$loop_category_id#2\"   $category_id_root_selected >$level1_loop. เป็นหมวดย่อยของ : $loop_category_name</option>";
...
$category_rs2 = $app_category->function_viewbyset( $input_array ); /// select ข้อมูล
...
print "<option value=\"$loop2_category_id#3\"  $category_id_root_selected >$level1_loop.$level2_loop เป็นหมวดย่อยของ : $loop2_category_name</option>";
...
?>
            ...
            <tr>
              <td align="right" valign="top" bgcolor="#FFFFFF"  style="padding:5px; background-color:#E5E5E5">รายละเอียด :</td>
              ...
              <tr>
                <td bgcolor="#FFFFFF" style="padding:0px;"><table width="100%" border="0" cellpadding="2" cellspacing="2" class="text1">
                  <tr bgcolor="#FFFFFF" class="text_normal1">
                    <td width="200" align="right" valign="middle"  style="padding:5px; background-color:#E5E5E5">ชื่อหมวดหมู่ <font color="#FF0000">*</font> :</td>
...
?>              
            ...
            <tr>
              <td align="right" valign="top"  style="padding:5px; background-color:#E5E5E5">รูปประกอบ ขนาดเล็ก :</td>
              <td align="left" valign="top" bgcolor="#FFFFFF"  style="padding:5px; background-color:#FFFFFF">
...
?>
            ...
            <tr>
              <td align="right" valign="top"  style="padding:5px; background-color:#E5E5E5">รูปประกอบ ขนาดใหญ่ :</td>
              <td align="left" valign="top" bgcolor="#FFFFFF"  style="padding:5px; background-color:#FFFFFF">
