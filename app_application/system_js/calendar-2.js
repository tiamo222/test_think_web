/////////////////////////////////////////////////////////// Start Lek
////// Modify from the old calendar 
/////// Detail modify : After calendar area is closed (function closeCalendarSub line 213), It will call new function. (function call_function).
...
//	dayName = new Array	("Mon","Tue","Wed","Thu","Fri","Sat","Sun")
	...
	function init()	{
		if (!ns4)
		{
			...
			if (showToday==1)
			{
				document.getElementById("lblToday").innerHTML =	todayString + " <a onmousemove='window.status=\""+gotoString+"\"' onmouseout='window.status=\"\"' title='"+gotoString+"' style='"+styleAnchor+"' href='javascript:monthSelected=monthNow;yearSelected=yearNow;constructCalendarSub();'>"+dayFullName[(today.getDay()-startAt==-1)?6:(today.getDay()-startAt)]+", " + dateNow + " " + monthName[monthNow]	+ "	" +	(yearNow+ThaiYear) + "</a>"
			}
	...
	function constructMonth() {
		...
		if (!monthConstructed) {
			...
			for	(i=0; i<12;	i++) {
				...
				sHTML += "<tr><td id='m" + i + "' onmouseover='this.style.backgroundColor=\"#FFCC99\"' onmouseout='this.style.backgroundColor=\"\"' style='cursor:pointer' onclick='monthConstructed=false;monthSelected=" + i + ";constructCalendarSub();popDownMonth();event.cancelBubble=true'>&nbsp;" + sName + "&nbsp;</td></tr>"
			}
   ...
   function WeekNbr(n) {
	...
	function constructCalendarSub () {
		...
		for	( datePointer=1; datePointer<=numDaysInMonth; datePointer++ )
		{
			...
			{ sHTML += "<b><a "+dateMessage+" title=\"" + sHint + "\" style='"+sStyle+"' href='javascript:dateSelected="+datePointer+";closeCalendarSub();'><font color=#ff0000>&nbsp;" + datePointer + "</font>&nbsp;</a></b>"}
			else if	(dayPointer % 7 == (startAt * -1)+1)
			{ sHTML += "<a "+dateMessage+" title=\"" + sHint + "\" style='"+sStyle+"' href='javascript:dateSelected="+datePointer + ";closeCalendarSub();'>&nbsp;<font color=#909090>" + datePointer + "</font>&nbsp;</a>" }
			else
			{ sHTML += "<a "+dateMessage+" title=\"" + sHint + "\" style='"+sStyle+"' href='javascript:dateSelected="+datePointer + ";closeCalendarSub();'>&nbsp;" + datePointer + "&nbsp;</a>" }
	...
	function popUpCalendarSub(ctl,	ctl2, format, Lpos) {
// -212 : Right
// 0    : Left
// -106  : Center	
		var	leftpos=0
...
//				crossobj.left =	fixedX==-1 ? ctl.offsetLeft + leftpos : fixedX
				...
				constructCalendarSub (1, monthSelected, yearSelected);
			...
			{
				hideCalendar()
				if (ctlNow!=ctl) {popUpCalendarSub(ctl, ctl2, format)}
			}
			ctlNow = ctl
		}
	}
...
////////////////////////////////////////////////////////
	function click_date_sub(form,element){
		popUpCalendarSub(form, element, "dd/mm/yyyy");
	}
/////////////////////////////////////////////////////////// End Lek