...
$access_page_id = "/backoffice/system_user_showall.php";
...
$array_group_name["$level1_group_id"]["group_name"] = $level1_group_name ; 
...
$page_topic_name = "แสดงรายการข้อมูล Administrator  ทั้งหมด "; 
  ...
  <tr>
    <td height="30" align="right" bgcolor="#FFFFFF" ><table border="0" cellpadding="0" cellspacing="5">
      <tr>
        ...
        <td width="60" align="center" valign="top" style=""><a href="system_user_update.php?category_id=<?=$category_id?>"><img src="../images/icon/design_icon_add.gif" alt="เพิ่ม" width="164" height="35" border="0" /></a></td>
      </tr>
    </table></td>
  </tr>
</table>
        ...
        <tr>
          <td height="50" align="left" valign="top" bgcolor="#FFFFFF"  style="padding:5px; background-color:#EEEEEE"><table border="0" cellpadding="0" cellspacing="2">
            <tr>
              ...
              <td><span class="text_normal1"><b>ประเภท </b></span></td>
              <td><span class="text_normal1">ค้นหาสมาชิก , ชื่อ , login , นามแฝง</span></td>
              <td>&nbsp;</td>
              <td>&nbsp;</td>
            </tr>
            <tr>
              <td align="right"><span class="text_normal1">ค้นหาข้อมูลจาก :</span></td>
              <td>
<?
...
<option  value=\"none\" selected>เลือกประเภท Group Administrator </option>
";
...
?>
      ...
      <table width="100%" border="0" cellpadding="0" cellspacing="1" bgcolor="#333333">
        <tr>
          ...
          <td width="60" align="center" bgcolor="#999999" style="width:60px;" class="text_normal1"  ><b>รูปภาพ</b></td>
          <td  bgcolor="#999999" class="text_normal1" ><b>&nbsp;ข้อมูลสมาชิก</b></td>
          <td align="center" bgcolor="#999999"   style="width:200px;" class="text_normal1"><b>Admin User Group</b></td>
          <td  align="center" bgcolor="#999999"   style="width:300px;" class="text_normal1"><b> Option</b></td>
...
$user_rs = $system_user->function_viewbyset( $input_array ); /// select ข้อมูล
...
$user_group_name = $array_group_name["$user_group_id"]["group_name"];
if ($user_group_name == "" ){
$user_group_name = "<font color=\"#FF0000\"> กรุณากำหนด กลุ่มดูแลระบบ <br>สำหรับ User รายการนี้ </font>"; 
}
...
print "
ID : $user_id <br>
ชื่อ-สกุล : <b>$user_firstname &nbsp;$user_lastname  $user_nickname</b><br>
นามแฝง : <b>$user_displayname</b><br />
...
?>
          ...
          <td  align="center" valign="middle" bgcolor="#FFFFFF" style="padding:2px;width:200px;" ><b><?=$user_group_name ?></b></td>
...
สถานะยืนยันตัวตนของสมาชิก (User Confirm)<br>
";
...
?>
  ...
  <a href="system_user_showall.php?<? print "user_id=$user_id&option_delete=delete&category_id=$category_id" ; ?>"   onclick="return confirm('คุณต้องการลบข้อมูลใช่หรือไม่ ?')"  ><img src="../images/icon/icon_mini_delete.gif" width="25" height="25" border="0"  /></a>
