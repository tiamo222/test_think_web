...
$access_page_id = "/backoffice/update_profile.php";
...
if (empty($_REQUEST["appaction_update_user"]) )  {  $appaction_update_user="";  } else { $appaction_update_user=$_REQUEST["appaction_update_user"];  }


if ($appaction_update_user == "update_information") {
...
if ($show_status == "success" ){ 
header("Location:update_profile.php?show_status=$show_status"); 
} 
...
?></td>
          ...
          <td width="250" align="left" valign="top" bgcolor="#FFFFFF" class="text_bot1"  style="padding:3px; background-color:#E5E5E5"> Picture ::
<table width="100" border="0" cellpadding="0" cellspacing="0">
              <tr>
                <td><img src="../images/span.gif" width="100" height="5" /></td>
              </tr>
...
?>
            ...
            <table width="100" border="0" cellpadding="0" cellspacing="0">
              <tr>
                <td><img src="../images/span.gif" width="250" height="10" /></td>
                </tr>
              </table></td>
        </tr>
      </table>
  ...
  <input  type="hidden" name="appaction_update_user"  id="appaction_update_user" value="update_information" />
