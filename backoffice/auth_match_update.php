...
<td width="60" align="center" valign="top">
 <a href="category_showall.php?<? print "category_id=$category_id&option_delete=delete&system_id=$system_id" ; ?>"   onclick="return confirm('سͧź ?')"  >
...
?>
   <td width="60" align="center" valign="top"><a href="x_system_auth_page_update.php?system_id=<?=$system_id?>"><img src="../images/icon/design_icon_add.gif" alt="" width="164" height="35" hspace="0" border="0" /></a></td>
                  </tr>
                </table></td>
              </tr>
            </table></td>
