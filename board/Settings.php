...
$boarddir = '/thinksoft/board';		# The absolute path to the forum's folder. (not just '.'!)
$sourcedir = '/thinksoft.co.th/board/Sources';		# Path to the Sources directory.
$cachedir = '/thinksoft.co.th/board/cache';		# Path to the cache directory.
