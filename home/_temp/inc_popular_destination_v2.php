<table width="100" border="0" align="center" cellpadding="0" cellspacing="0">
      <tr>
        <td><img src="../images/span.gif" width="100" height="15" /></td>
      </tr>
    </table>
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td width="1"><img src="../images/design_v2/boxb1.gif" width="9" height="35" /></td>
    <td width="1"  style="background-image:url(../images/design_v2/boxbg1.gif)"><img src="../images/design_v2/box_icon2.gif" width="45" height="35" /></td>
    <td align="left" class="big1" style="background-image:url(../images/design_v2/boxbg1.gif)">&nbsp;&nbsp; <font color="#FFFFFF">แนะนำสถานที่ท่องเที่ยวยอดนิยม </font></td>
...
<table width="612" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    ...
    <td height="50" align="left" valign="top"  style="background-color:#F8F6F4; padding-top:15px;" ><?
...
?>
          <td width="50" align="center" valign="top" style="padding:2px"><table width="100%" border="0" align="center" cellpadding="4" cellspacing="1" style="background-color:#E7E2D5;">
            <tr>
              <td bgcolor="#FFFFFF"><a href="../populardestination/detail.php?id=<?=$content_id ?>">
                <?=$content_image_mini_show?>
              </a></td>
            </tr>
          </table></td>
...
?>
      ...
      <table width="97%" border="0" align="center" cellpadding="0" cellspacing="5">
        <tr>
          <td height="35" align="right" valign="middle"  class="text2"><a href="../populardestination/"><font color="#DA3C3C"><?=$tag["#text_readmore#"]["lang_info"] ?> </font><img src="../images/design_agency4/boxpop_more.gif" width="9" height="12" border="0" align="absmiddle" /></a></td>
        </tr>
      </table><br />
    ...
    <td width="1" align="center" valign="top"><img src="../images/span.gif" width="1" height="4" /></td>
  </tr>
</table>
<?
