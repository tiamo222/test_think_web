...
/// print "sql_get_banner = $sql_get_banner <br>";
...
/// print "count_banner = $count_banner <br>";
...
$banner_code_show = "<img src=\"upload/adsbanner/$loop_banner_image\" border=0 >"; 
if ($loop_banner_url != "" ) { 
